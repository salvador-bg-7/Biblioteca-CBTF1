...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Revistas' OR cat2 LIKE 'Revistas' 
OR cat3 LIKE 'Revistas' OR cat4 LIKE 'Revistas'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat34.php" method="POST" id="cat1">
