...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Educación' OR cat2 LIKE 'Educación' 
OR cat3 LIKE 'Educación' OR cat4 LIKE 'Educación'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat12.php" method="POST" id="cat1">
