...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Historia' OR cat2 LIKE 'Historia' 
OR cat3 LIKE 'Historia' OR cat4 LIKE 'Historia'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat23.php" method="POST" id="cat1">
