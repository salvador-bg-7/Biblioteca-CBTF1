...
<form method="POST" name="foeditar" action="datosborrar.php" autocomplete="off"> 
<table align="center" border="0">
    ...
    <tr>
        <td align="center">
            <h6>Escribe el folio del Libro que será borrado de la base de datos:</h6>
        </td>
    </tr>
    <tr></tr>
    <tr></tr>
    ...
    <tr>
        <td align="center">
            <input type="text" id="folioe" name="folioe" size="20" placeholder="Folio del libro" required>
        </td>
    </tr>
    <tr></tr>
    <tr></tr>
    ...
    <tr>
        <td align="center">
		<button id="editarl" type="submit">Checar Datos de Libro</button>
        </td>
    </tr>
</table> 
</form>
