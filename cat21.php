...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Geometría' OR cat2 LIKE 'Geometría' 
OR cat3 LIKE 'Geometría' OR cat4 LIKE 'Geometría'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat21.php" method="POST" id="cat1">
