...
$pdf->Cell(245,10, ('Reporte de solicitudes rechazadas: '), 0, 1, 'L');
...
$pdf->MultiCell(w:0, h:10, txt: utf8_decode('En la siguiente tabla se muestra el reporte de las solicitudes de préstamo de libros que han sido rechazadas por parte de la '
.'Biblioteca del Centro de Bachillerato Tecnológico Forestal 1 (CBTF1) de la fecha: '
.utf8_decode(str_replace('-', '/', date('d-m-Y', strtotime($fecha1)))
...
$pdf->Cell(245,5, ('Total de solicitudes: '.$numero), 0, 1, 'R');
...
$pdf->Cell(80,10, utf8_decode(('Motivo')), 1, 1, 'C',1);
...
while ($row = mysqli_fetch_assoc($buscador)) { 
    ...
    $pdf->Cell(80,10, utf8_decode($row['motivo']), 1, 1, 'C',1);
