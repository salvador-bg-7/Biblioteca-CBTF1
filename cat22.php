...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Guías' OR cat2 LIKE 'Guías' 
OR cat3 LIKE 'Guías' OR cat4 LIKE 'Guías'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat22.php" method="POST" id="cat1">
