...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Ecología' OR cat2 LIKE 'Ecología' 
OR cat3 LIKE 'Ecología' OR cat4 LIKE 'Ecología'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat11.php" method="POST" id="cat1">
