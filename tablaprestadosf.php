...
$pdf->Cell(245,10, ('Reporte de Libros prestados: '), 0, 1, 'L');
...
$pdf->MultiCell(w:0, h:10, txt: utf8_decode('En la siguiente tabla se muestra el reporte completo de los libros que han sido prestados por parte de la '
.'Biblioteca del Centro de Bachillerato Tecnológico Forestal 1 (CBTF1). de la fecha: '.utf8_decode(str_replace('-', '/', date('d-m-Y', strtotime($fecha1)))).
