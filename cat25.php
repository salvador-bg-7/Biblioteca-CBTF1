...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Informática' OR cat2 LIKE 'Informática' 
OR cat3 LIKE 'Informática' OR cat4 LIKE 'Informática'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat25.php" method="POST" id="cat1">
