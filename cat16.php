...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Etimología' OR cat2 LIKE 'Etimología' 
OR cat3 LIKE 'Etimología' OR cat4 LIKE 'Etimología'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat16.php" method="POST" id="cat1">
