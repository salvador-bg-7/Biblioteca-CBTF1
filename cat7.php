...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Calculo' OR cat2 LIKE 'Calculo' 
OR cat3 LIKE 'Calculo' OR cat4 LIKE 'Calculo'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat7.php" method="POST" id="cat1">
