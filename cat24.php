...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'INEGI' OR cat2 LIKE 'INEGI' 
OR cat3 LIKE 'INEGI' OR cat4 LIKE 'INEGI'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat24.php" method="POST" id="cat1">
