...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Ingles' OR cat2 LIKE 'Ingles' 
OR cat3 LIKE 'Ingles' OR cat4 LIKE 'Ingles'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat26.php" method="POST" id="cat1">
