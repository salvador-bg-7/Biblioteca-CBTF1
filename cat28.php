...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Lógica' OR cat2 LIKE 'Lógica' 
OR cat3 LIKE 'Lógica' OR cat4 LIKE 'Lógica'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat28.php" method="POST" id="cat1">
