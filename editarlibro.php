...
<form method="POST" name="foeditar" action="editarlibrodatos.php" autocomplete="off"> 
<table align="center" border="0">
    ...
    <tr>
        <td align="center">
            <h6>Escribe el folio del Libro a editar:</h6>
        </td>
    </tr>
    <tr></tr>
    <tr></tr>
    ...
    <tr>
        <td align="center">
            <input type="text" id="folioe" name="folioe" size="29" placeholder="Folio del libro a editar">
        </td>
    </tr>
    <tr></tr>
    <tr></tr>
    ...
    <tr>
        <td align="center">
		<button id="editarl" type="submit">Editar Libro</button>
        </td>
    </tr>
</table> 
</form>
