...
' fue devuelto a la Biblioteca del Centro de Bachillerato Tecnológico Forestal 1 (CBTF1) por '.$nos.' con matricula '
.$mas.', en la fecha de '.(str_replace('-', '/', date('d-m-Y', strtotime($fed)))).' en las condiciones que a continuacion se describe: '.$mot.'.'), border:0, align:'J');
