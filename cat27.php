...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Lectura y Redacción' OR cat2 LIKE 'Lectura y Redacción' 
OR cat3 LIKE 'Lectura y Redacción' OR cat4 LIKE 'Lectura y Redacción'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat27.php" method="POST" id="cat1">
