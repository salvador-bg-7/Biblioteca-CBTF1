...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Tutorías' OR cat2 LIKE 'Tutorías' 
OR cat3 LIKE 'Tutorías' OR cat4 LIKE 'Tutorías'";
...
<body style="background-color:  #F2F2F2;">
    <center>
        ...
        <form name="cat1" action="filtrocat36.php" method="POST" id="cat1">
