...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Agropecuaria' OR cat2 LIKE 'Agropecuaria' 
OR cat3 LIKE 'Agropecuaria' OR cat4 LIKE 'Agropecuaria'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat2.php" method="POST" id="cat1">
