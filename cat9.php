...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Contabilidad' OR cat2 LIKE 'Contabilidad' 
OR cat3 LIKE 'Contabilidad' OR cat4 LIKE 'Contabilidad'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat9.php" method="POST" id="cat1">
