...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Ciencias Sociales' OR cat2 LIKE 'Ciencias Sociales' 
OR cat3 LIKE 'Ciencias Sociales' OR cat4 LIKE 'Ciencias Sociales'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat8.php" method="POST" id="cat1">
