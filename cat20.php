...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Geografía' OR cat2 LIKE 'Geografía' 
OR cat3 LIKE 'Geografía' OR cat4 LIKE 'Geografía'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat20.php" method="POST" id="cat1">
