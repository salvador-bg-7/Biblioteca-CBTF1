				...
				<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
					...
					<tr>
						<div class="form-group">
							<td colspan="10" align="right">
								<div style="margin-bottom: 10px" class="col-md-9">
									<label for="usuario" class="col-md-3 control-label">Matricula:
									</label>
								</div>
							</td>
							<td colspan="10" align="center">
								<div style="margin-bottom: 10px" class="col-md-9">
									<input type="text" class="form-control" name="matricula" placeholder="Matricula" value="<?php if (isset($matricula)) echo $matricula; ?>" required>
								</div>
							</td>
						</div>
					</tr>
					...
					<tr>
						<div class="form-group">
							<td colspan="10" align="right">
								...
								<div style="margin-bottom: 10px" class="col-md-9">
									<label for="esp" class="col-md-3 control-label">Especialidad:
									</label>
								</div>
							</td>
							<td align="center">
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <select name="esp" value="<?php if (isset($esp)) echo $esp; ?>" required>
                                <option> </option>
