...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Enciclopedias' OR cat2 LIKE 'Enciclopedias' 
OR cat3 LIKE 'Enciclopedias' OR cat4 LIKE 'Enciclopedias'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat13.php" method="POST" id="cat1">
