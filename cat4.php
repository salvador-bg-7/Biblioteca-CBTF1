...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Artes' OR cat2 LIKE 'Artes' 
OR cat3 LIKE 'Artes' OR cat4 LIKE 'Artes'";
...
<div class="contenedorcabeza">
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat4.php" method="POST" id="cat1">
