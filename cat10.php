...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Derecho' OR cat2 LIKE 'Derecho' 
OR cat3 LIKE 'Derecho' OR cat4 LIKE 'Derecho'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat10.php" method="POST" id="cat1">
