...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Estadística' OR cat2 LIKE 'Estadística' 
OR cat3 LIKE 'Estadística' OR cat4 LIKE 'Estadística'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat14.php" method="POST" id="cat1">
