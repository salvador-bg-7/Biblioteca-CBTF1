...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Algebra' OR cat2 LIKE 'Algebra' 
OR cat3 LIKE 'Algebra' OR cat4 LIKE 'Algebra'";
...
<div class="contenedorcabeza">
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat3.php" method="POST" id="cat1">
