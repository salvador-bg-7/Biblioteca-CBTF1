...
$pdf->MultiCell(w:0, h:10, txt: utf8_decode('En la siguiente tabla se muestra el reporte completo de todos los libros que han sido prestados por parte de la '
...
while ($row = mysqli_fetch_assoc($buscador)) { 
    ...
    $pdf->Cell(40,10, utf8_decode(str_replace('-', '/', date('d-m-Y', strtotime($row['fechadev'])))), 1, 1, 'C',1);
