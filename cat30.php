...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Orientación' OR cat2 LIKE 'Orientación' 
OR cat3 LIKE 'Orientación' OR cat4 LIKE 'Orientación'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat30.php" method="POST" id="cat1">
