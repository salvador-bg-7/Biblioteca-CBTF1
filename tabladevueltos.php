...
$pdf->Cell(245,10, ('Reporte completo de Libros prestados: '), 0, 1, 'L');
...
$pdf->MultiCell(w:0, h:10, txt: utf8_decode('En la siguiente tabla se muestra el reporte completo de todos los libros que han sido devueltos por alumnos, maestros y personal administrativo a la '
