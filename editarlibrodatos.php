...
$foled = $mysqli->real_escape_string($_POST['folioe']);
...
<center>
        <table border="0">
            ...
            <form id="editar" action="modificar.php" method="POST" autocomplete="off" enctype="multipart/form-data">
			...
			<input id="dis" name="dis" type="hidden" value="<?php echo $row['disponibilidad']; ?>">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div style="margin-bottom: 10px" class="col-md-9">
						<input type="text" size="147" name="titulo" value="<?php echo $row['titulo']; ?>" required>
                ...
                <tr>
                    ...
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="sub1" placeholder="Subtitulo del Libro" value="<?php echo $row['sub1']; ?>" required>
                        </div>
                    </td>
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="sub2" placeholder="Subtitulo del Libro" value="<?php echo $row['sub2']; ?>">
                        </div>
                    </td>
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="sub3" placeholder="Subtitulo del Libro" value="<?php echo $row['sub3']; ?>">
                        </div>
                    </td>
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="sub4" placeholder="Subtitulo del Libro" value="<?php echo $row['sub4']; ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="autor1" placeholder="Autor del Libro" value="<?php echo $row['autor1']; ?>" required>
                        </div>
                    </td>
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="autor2" placeholder="Autor del Libro" value="<?php echo $row['autor2']; ?>">
                        </div>
                    </td>
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="autor3" placeholder="Autor del Libro" value="<?php echo $row['autor3']; ?>">
                        </div>
                    </td>
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="autor4" placeholder="Autor del Libro" value="<?php echo $row['autor4']; ?>">
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="147" class="form-control" name="editorial" placeholder="Editorial del Libro" value="<?php echo $row['editorial']; ?>" required>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="paginas" placeholder="Paginas del Libro" value="<?php echo $row['paginas']; ?>" required>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div style="margin-bottom: 10px" class="col-md-9">
                            <input type="text" size="30" class="form-control" name="edicion" placeholder="Edición del Libro" value="<?php echo $row['edicion']; ?>" required>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <form method="POST" action="editarfoto.php" name="editarfoto" id="editarfoto"> 
                    <td>
                        <div class="form-group">
