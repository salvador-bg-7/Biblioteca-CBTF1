...
$pdf->Cell(80,10, (''), 0, 1, 'R');
$pdf->Cell(160,10, ('Reporte de libro devuelto: '), 0, 1, 'L');
$pdf->Cell(80,10, $tit, 0, 0, 'L');
$pdf->Cell(80,10, $hoy, 0, 1, 'R');
$pdf->Cell(160,10, (''), 0, 1, 'R');
$pdf->Cell(160,10, (''), 0, 1, 'R');

$pdf->SetFont('Arial','',12);

$pdf->MultiCell(w:0, h:10,  txt: utf8_decode('El Libro '.$tit.' con umero de folio '.$fol.
' fue devueto a la Biblioteca del Centro de Bachillerato Tecnologico  Forestal 1 (CBTF1) por '.$nos.' con matricula '
.$mas.', en la fecha de '.$fed.' en las condiciones que acontinuacion se describe: '.$mot.'.'), border:0, align:'J');
