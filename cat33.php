...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Recursos Naturales' OR cat2 LIKE 'Recursos Naturales' 
OR cat3 LIKE 'Recursos Naturales' OR cat4 LIKE 'Recursos Naturales'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat33.php" method="POST" id="cat1">
