...
<form method="POST" name="foeditar" action="datosuborrar.php" autocomplete="off"> 
<table align="center" border="0">
    ...
    <tr>
        <td align="center">
            <h6>Escribe la Matricula del usuario que será borrado de la base de datos:</h6>
        </td>
    </tr>
    <tr></tr>
    <tr></tr>
    ...
    <tr>
        <td align="center">
            <input type="text" id="folioe" name="folioe" size="20" placeholder="Matricuala" required>
        </td>
    </tr>
    <tr></tr>
    <tr></tr>
    ...
    <tr>
        <td align="center">
		<button id="editarl" type="submit">Checar Datos de Usuario</button>
        </td>
    </tr>
</table> 
</form>
