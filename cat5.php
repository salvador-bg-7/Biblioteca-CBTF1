...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Atlas Nacional' OR cat2 LIKE 'Atlas Nacional' 
OR cat3 LIKE 'Atlas Nacional' OR cat4 LIKE 'Atlas Nacional'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat5.php" method="POST" id="cat1">
