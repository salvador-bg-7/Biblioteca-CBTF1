...
<div2>
    <h1>Préstamo de Libro Negado</h1>
</div2>
...
<form method="POST" name="negar" id="negar" action="registrarnegar.php">
<table border="0" align="center">
        ...
        <tr>
            ...
            <td align="center">
                <input type="text" size="70" name="motivo" placeholder="Describe el motivo por el cual se ha 
negado el prestamo del Libro" required>
            </td>
            <td></td>
            <td>
                <input type="submit" name="negar" value="Negar">
            </td>
