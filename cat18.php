...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Física' OR cat2 LIKE 'Física' 
OR cat3 LIKE 'Física' OR cat4 LIKE 'Física'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat18.php" method="POST" id="cat1">
