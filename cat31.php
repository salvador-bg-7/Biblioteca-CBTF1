...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Pscología' OR cat2 LIKE 'Pscología' 
OR cat3 LIKE 'Pscología' OR cat4 LIKE 'Pscología'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat31.php" method="POST" id="cat1">
