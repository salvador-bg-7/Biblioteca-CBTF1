...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Filosofía' OR cat2 LIKE 'Filosofía' 
OR cat3 LIKE 'Filosofía' OR cat4 LIKE 'Filosofía'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat17.php" method="POST" id="cat1">
