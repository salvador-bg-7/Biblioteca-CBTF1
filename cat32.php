...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Química' OR cat2 LIKE 'Química' 
OR cat3 LIKE 'Química' OR cat4 LIKE 'Química'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat32.php" method="POST" id="cat1">
