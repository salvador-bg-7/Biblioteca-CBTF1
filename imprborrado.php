...
$pdf->Cell(80,10, (''), 0, 1, 'R');
$pdf->Cell(160,10, ('Reporte de Libro Borrado: '), 0, 1, 'L');
$pdf->Cell(80,10, utf8_decode($tit), 0, 0, 'L');
$pdf->Cell(80,10, 
...
' fue borrado de la base de datos de  la Biblioteca del Centro de Bachillerato Tecnológico Forestal 1 (CBTF1)'. 
' por los siguientes motivos: '.$mot.', por lo cual ya no se encuentra disponible dentro del sistema. Este fue borrado en la fecha de '
.(str_replace('-', '/', date('d-m-Y', strtotime($fec)))).'.'), border:0, align:'J');
