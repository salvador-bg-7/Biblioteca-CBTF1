...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Ética' OR cat2 LIKE 'Ética' 
OR cat3 LIKE 'Ética' OR cat4 LIKE 'Ética'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat15.php" method="POST" id="cat1">
