...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Tecnología' OR cat2 LIKE 'Tecnología' 
OR cat3 LIKE 'Tecnología' OR cat4 LIKE 'Tecnología'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat35.php" method="POST" id="cat1">
