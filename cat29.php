...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Matemáticas' OR cat2 LIKE 'Matemáticas' 
OR cat3 LIKE 'Matemáticas' OR cat4 LIKE 'Matemáticas'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat29.php" method="POST" id="cat1">
