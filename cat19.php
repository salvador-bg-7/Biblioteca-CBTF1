...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Forestal' OR cat2 LIKE 'Forestal' 
OR cat3 LIKE 'Forestal' OR cat4 LIKE 'Forestal'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat19.php" method="POST" id="cat1">
