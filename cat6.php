...
$consul = "SELECT * FROM libros WHERE cat1 LIKE 'Biología' OR cat2 LIKE 'Biología' 
OR cat3 LIKE 'Biología' OR cat4 LIKE 'Biología'";
...
<div1>
    ...
    <center>
        ...
        <form name="cat1" action="filtrocat6.php" method="POST" id="cat1">
