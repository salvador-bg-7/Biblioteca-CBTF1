...
<div2>
    <h1>Historial de Libros Prestados</h1>
</div2>
...
<tr></tr>
<tr>
<form method="POST" name="completo" id="completo" action="tablaprestados.php" target="_blank">
...
<tr align="center">
    ...
    <?php while ($row = mysqli_fetch_assoc($buscador)) { 
        ...
        <form method="POST" name="imprimirprestados" id="imprimirprestados" action="imprimirprestados.php" target="_blank">
    ...
    <tr>
        ...
        <td></td>
        <td></td>
        <td align="center"><?php echo $row['cat1'], "<br><br>", $row['cat2'], "<br><br>", $row['cat3'], "<br><br>", 
        $row['cat4']; ?></td>
        <td></td>
        <td></td>
